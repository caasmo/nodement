...
function create(){
  ...
  function createChain(route){
    ...
    var preAllFuncs = routes[ALLROUTES_CHAIN].plugins.pre || [];
    var postAllFuncs = routes[ALLROUTES_CHAIN].plugins.post || [];
  ...
  addPlugin(ALLROUTES_CHAIN, addStandardHeaders, sendResponse, 'post');
