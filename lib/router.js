...
function addHelpers(module){
  ...
  //var child = addChild(helperContainer.prototype, module.pluginName);
  /*
  helperContainer.prototype[module.pluginName]['getSuper']= function(){
  ...
  for (var p in module.helpers) {  
    if(module.helpers.hasOwnProperty(p)){
      // if function TODO
      helperContainer.prototype[p] = function(){
        
        
        var args = Array.prototype.slice.call(arguments);
        //sys.puts("calling function");
        //sys.puts(sys.inspect(this));
        // if namespace subobject, this keyword is the subobject namespace 
        module.helpers[p].apply(this.response,args);
      }
...
function addChild(ob, childName)
{
   ob[childName] = {};
   ob[childName].parent = ob;
